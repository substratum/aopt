...
extern android::status_t buildResources(Bundle* bundle,
    const sp<AoptAssets>& assets, sp<ApkBuilder>& builder);

extern android::status_t writeResourceSymbols(Bundle* bundle,
        const sp<AoptAssets>& assets, const String8& pkgName,
        bool includePrivate, bool emitCallback);

extern android::status_t writeProguardFile(Bundle* bundle, const sp<AoptAssets>& assets);
extern android::status_t writeMainDexProguardFile(Bundle* bundle, const sp<AoptAssets>& assets);

extern bool isValidResourceType(const String8& type);

extern status_t filterResources(Bundle* bundle, const sp<AoptAssets>& assets);

int dumpResources(Bundle* bundle);

status_t writeDependencyPreReqs(Bundle* bundle, const sp<AoptAssets>& assets,
