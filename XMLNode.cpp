...
status_t parseXMLResource(const sp<AoptFile>& file, ResXMLTree* outTree,
                          ...
                          const char** cDataTags)
{
    ...
    sp<AoptFile> rsc = new AoptFile(String8(), AoptGroupEntry(), String8());
...
sp<XMLNode> XMLNode::parse(const sp<AoptFile>& file)
{
    char buf[16384];
...
status_t XMLNode::parseValues(const sp<AoptAssets>& assets,
                              ResourceTable* table)
{
...
status_t XMLNode::assignResourceIds(const sp<AoptAssets>& assets,
...
status_t XMLNode::flatten(const sp<AoptFile>& dest,
        bool stripComments, bool stripRawValues) const
{
    ...
    sp<AoptFile> stringPool = strings.createStringBlock();
...
status_t XMLNode::flatten_node(const StringPool& strings, const sp<AoptFile>& dest,
        bool stripComments, bool stripRawValues) const
{
