...
public:
     ...
     * to the AoptAssets, then they may be skipped over
    ...
    status_t addIncludedResources(Bundle* bundle, const sp<AoptAssets>& assets);
    ...
    sp<AoptFile> flatten(Bundle* bundle, const sp<const ResourceFilter>& filter,
            const bool isBase);
    ...
    status_t addSymbols(const sp<AoptSymbols>& outSymbols = NULL,
    ...
    status_t flatten(Bundle* bundle, const sp<const ResourceFilter>& filter,
            const sp<AoptFile>& dest, const bool isBase);
    status_t flattenLibraryTable(const sp<AoptFile>& dest, const Vector<sp<Package> >& libs);
    ...
    public:
        ...
        ssize_t flatten(Bundle*, const sp<AoptFile>& data, bool isPublic, bool isOverlay);
    ...
    public:
        ...
        const sp<AoptFile> getTypeStringsData() const { return mTypeStringsData; }
        status_t setTypeStrings(const sp<AoptFile>& data);
        ...
        const sp<AoptFile> getKeyStringsData() const { return mKeyStringsData; }
        status_t setKeyStrings(const sp<AoptFile>& data);
    ...
    private:
        status_t setStrings(const sp<AoptFile>& data,
        ...
        sp<AoptFile> mTypeStringsData;
        sp<AoptFile> mKeyStringsData;
